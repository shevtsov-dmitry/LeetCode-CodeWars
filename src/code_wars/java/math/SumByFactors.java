...
/*  Testing [-29804, -4209, -28265, -72769, -31744]
    ...
    public static void fillMapWithOccurrences(int el, Integer primeFactor, Map<Integer, List<Integer>> map) {
    ...
    public static void fillListWithPrimeFactorsOfElement(List<Integer> primeFactorsOfEl, int el) {
        if(el >= 0){
            for (int i = el; i > 1; i--) {
                if (el % i == 0) {
